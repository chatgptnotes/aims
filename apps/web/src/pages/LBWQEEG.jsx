                      ...
                      <div className="w-full bg-gray-200 rounded-full h-3">
                        <div
                          className={`h-3 rounded-full transition-all duration-500 ${
                            wave.status === 'optimal' ? 'bg-green-500' :
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                <div className="bg-white rounded-2xl shadow-lg p-8">
                  ...
                  <div className="relative">
                    ...
                    <div className="absolute top-1/4 left-1/4 w-8 h-8 bg-green-500 rounded-full opacity-60 animate-pulse"></div>
                    <div className="absolute top-1/3 right-1/3 w-6 h-6 bg-yellow-500 rounded-full opacity-60 animate-pulse"></div>
                    <div className="absolute bottom-1/4 left-1/3 w-7 h-7 bg-blue-500 rounded-full opacity-60 animate-pulse"></div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  >
                    {protocol.recommended && (
                      <div className="inline-block px-3 py-1 bg-indigo-600 text-white text-xs font-medium rounded-full mb-3">
                        Recommended
                      </div>
                    )}
                    ...
                    <button className="w-full px-4 py-2 bg-white hover:bg-gray-50 text-indigo-600 border border-indigo-600 rounded-lg font-medium transition-colors">
                      Start Protocol
                    </button>
                  </div>
                ))}
