  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="fixed top-0 left-0 right-0 h-1 bg-gray-200 z-[60]">
        <div
          className="h-full bg-gradient-to-r from-[#0066CC] to-[#00BFA5] transition-all duration-150 ease-out"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center bg-white/98 backdrop-blur-md rounded-full shadow-md px-6 py-2.5 gap-8">
              ...
              <div className="flex items-center space-x-6">
                <a href="#how-it-works" className="text-sm text-gray-700 hover:text-gray-900 font-normal transition-colors">How It Works</a>
                <a href="#benefits" className="text-sm text-gray-700 hover:text-gray-900 font-normal transition-colors">Benefits</a>
                <a href="#testimonials" className="text-sm text-gray-700 hover:text-gray-900 font-normal transition-colors">Reviews</a>
                <a href="#experts" className="text-sm text-gray-700 hover:text-gray-900 font-normal transition-colors">Our Team</a>
              </div>
              ...
              <div className="flex items-center space-x-2.5">
                <Link
                  to="/login"
                  className="px-5 py-2 bg-[#00897B] text-white font-medium text-sm rounded-full hover:bg-[#00796B] transition-all duration-300"
                >
                  Start
                </Link>
                <Link
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white border-t border-gray-200 animate-fade-in mt-2 rounded-2xl mx-4 shadow-lg">
            <div className="px-4 py-6 space-y-4">
              <a href="#how-it-works" className="block text-gray-600 hover:text-gray-900 font-medium py-2" onClick={toggleMobileMenu}>How It Works</a>
              <a href="#benefits" className="block text-gray-600 hover:text-gray-900 font-medium py-2" onClick={toggleMobileMenu}>Benefits</a>
              <a href="#testimonials" className="block text-gray-600 hover:text-gray-900 font-medium py-2" onClick={toggleMobileMenu}>Reviews</a>
              <a href="#experts" className="block text-gray-600 hover:text-gray-900 font-medium py-2" onClick={toggleMobileMenu}>Our Team</a>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                step: '03',
                icon: Brain,
                title: 'Train with Our Platform',
                description: 'Use guided neurofeedback training and track your progress in real-time with our advanced platform'
              },
              {
                step: '04',
                icon: TrendingUp,
              ...
              >
                ...
                {index < 3 && (
                  <div className="hidden lg:block absolute top-12 left-full w-full h-0.5 bg-gradient-to-r from-[#0066CC] to-[#00BFA5] opacity-20 z-0"></div>
                )}
                ...
                <div className="relative bg-white border-2 border-gray-100 rounded-2xl p-8 transition-all duration-300 hover:border-[#0066CC] hover:shadow-xl hover:-translate-y-2 z-10">
                  {/* Step Number */}
                  <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-[#0066CC] to-[#00BFA5] rounded-full flex items-center justify-center text-white font-bold text-lg shadow-lg">
                    {item.step}
                  </div>
      ...
      {/* Stats Section */}
      <section className="py-20 lg:py-28 bg-gradient-to-br from-[#0066CC] to-[#00BFA5] text-white overflow-hidden relative">
        {/* Background Pattern */}
      ...
      <section id="testimonials" className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-gradient-to-r from-[#0066CC] to-[#00BFA5] rounded-2xl p-8 text-center text-white">
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl border border-gray-100 hidden lg:block">
                  <div className="flex items-center space-x-3">
                    <Award className="w-10 h-10 text-[#00BFA5]" />
                    <div>
            ...
            <table className="w-full border-collapse bg-white rounded-2xl overflow-hidden shadow-xl">
              <thead>
                <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                  ...
                  <th className="py-6 px-6 text-center text-sm font-bold bg-gradient-to-br from-[#0066CC] to-[#00BFA5] text-white uppercase tracking-wider">
      ...
      <section className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-[#0066CC] via-[#00BFA5] to-[#0066CC]"></div>
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-[#0066CC] to-[#00BFA5] rounded-2xl p-8 transform scale-105 shadow-2xl relative">
      ...
      <section className="py-20 lg:py-28 bg-gradient-to-br from-[#0066CC] to-[#00BFA5] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <a
              href="#how-it-works"
              className="inline-flex items-center justify-center px-8 py-4 bg-transparent text-white font-semibold rounded-full border-2 border-white hover:bg-white hover:text-[#0066CC] transition-all duration-300"
            >
              Learn More
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-[#0066CC] transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="hover:text-[#00BFA5] transition-colors">Research & Studies</a></li>
                ...
                <li><a href="#" className="hover:text-[#00BFA5] transition-colors">Contact Us</a></li>
              </ul>
            </div>
          ...
          <div className="pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-6 text-sm">
                <a href="#" className="hover:text-[#00BFA5] transition-colors">Privacy Policy</a>
                <a href="#" className="hover:text-[#00BFA5] transition-colors">Terms of Service</a>
                <a href="#" className="hover:text-[#00BFA5] transition-colors">Cookie Settings</a>
              </div>
            </div>
          </div>
        </div>
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 z-50 w-14 h-14 bg-gradient-to-br from-[#0066CC] to-[#00BFA5] text-white rounded-full shadow-2xl hover:shadow-xl transform hover:scale-110 transition-all duration-300 flex items-center justify-center group animate-fade-in"
          ...
          >
            <div className="flex items-start space-x-3">
              <div className="flex-shrink-0">
                <div className="w-10 h-10 bg-gradient-to-br from-[#0066CC] to-[#00BFA5] rounded-full flex items-center justify-center">
      ...
      {showCookieBanner && (
        <div className="fixed bottom-0 left-0 right-0 bg-gray-900 text-white p-4 z-50 shadow-2xl animate-slide-up">
          <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-start space-x-3">
              <Shield className="w-6 h-6 text-[#00BFA5] flex-shrink-0 mt-1" />
              <div className="flex-1">
                <p className="text-sm font-medium mb-1">We value your privacy</p>
                <p className="text-xs text-gray-300">
                  We use cookies to enhance your experience, analyze traffic, and personalize content.{' '}
                  <a href="#" className="underline hover:text-[#00BFA5]">Learn more</a>
                </p>
              </div>
            </div>
            <div className="flex space-x-3 flex-shrink-0">
              ...
              <button
                onClick={() => setShowCookieBanner(false)}
                className="px-4 py-2 bg-gradient-to-r from-[#0066CC] to-[#00BFA5] text-white text-sm font-bold rounded-lg hover:shadow-lg transition-all"
              >
                Accept All
              </button>
            </div>
