...
const NotificationCenter = () => {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      ...
      case 'success':
        return <CheckCircle className="w-5 h-5 text-[#323956]" />;
      default:
        return <Bell className="w-5 h-5 text-[#323956]" />;
    }
  };
                ...
                <div className="flex items-start gap-3 flex-1">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {!notification.isRead && (
                        <span className="w-2 h-2 bg-[#323956] rounded-full"></span>
                      )}
                    </div>
