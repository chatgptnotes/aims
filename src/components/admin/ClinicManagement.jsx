  ...
  const handleCreateClinic = async (data) => {
    try {
      ...
      const clinicData = {
        ...
        password: data.password, // This is the field used for login
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  onClick={async () => {
                    try {
                      const password = clinic.password || '';
                      if (navigator.clipboard && window.isSecureContext) {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-4">
            <div className="relative">
              <div className="h-16 w-16 rounded-full bg-gradient-to-br from-[#E4EFFF]0 via-purple-600 to-indigo-600 flex items-center justify-center text-white font-bold text-xl shadow-lg overflow-hidden">
                {clinic.avatar ? (
                  <img 
                    src={clinic.avatar} 
                    alt={`${clinic.name} Profile`} 
