          ...
          <div className="field-wrapper animate-slide-up" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="relative">
              {watchUserType === 'super_admin' ? (
                <Shield className={`input-icon ${errors.userType ? 'text-red-400' : 'text-[#323956]'}`} />
              ) : watchUserType === 'patient' ? (
                <Heart className={`input-icon ${errors.userType ? 'text-red-400' : 'text-[#323956]'}`} />
              ) : (
                <Building2 className={`input-icon ${errors.userType ? 'text-red-400' : 'text-[#323956]'}`} />
              )}
              <select
                id="userType"
