import PIDUpload from '../components/features/PIDUpload'
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-4">P&ID Brain Mapping</h1>
          ...
          <Card className="p-6 mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">What is P&ID Brain Mapping?</h2>
          ...
          <Card className="p-6 mt-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-6">Benefits of P&ID Analysis</h2>
