# P&ID Algorithm Processor Setup Instructions

## Overview
This system integrates OpenAI API with your P&ID Algorithm Data Processor to calculate 7 brain health parameters from uploaded P&ID files (PDF or CSV/Excel).
...
2. **File Parsing**: Backend parses files using:
   - PDF files → OpenAI Vision API extracts P&ID tables
...
### Process P&ID Files
```
POST http://localhost:3001/api/pid/process
